...
#include "../Takuzu/include/model/Model.hpp"
...
QT_MOC_LITERAL(1, 6, 15), // "newCellSelected"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8), // "nextMove"
QT_MOC_LITERAL(4, 32, 3), // "row"
QT_MOC_LITERAL(5, 36, 6) // "column"

    },
    "Model\0newCellSelected\0\0nextMove\0row\0"
    "column"
};
...
void Model::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newCellSelected(); break;
        case 1: _t->nextMove((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Model::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Model::newCellSelected)) {
                *result = 0;
                return;
            }
        }
